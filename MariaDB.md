...
*PRIMARY KEY:*
cpf_funcionario, nome_dependente
...
**Tabela Localizações Departamento**
...
*PRIMARY KEY:*
cpf_funcionario, numero_projeto
...
# Fazendo Relação Entre as Tabelas:

*ALTER TABLE USADO PARA INSERIR AS FOREIGN KEYS E RELACIONAR COM OUTRAS TABELAS*


*REFERENCES USADO PARA REFERENCIAR À OUTRA TABELA*
...
*INSERT INTO USADO PARA INSERIR OS DADOS NAS DEVIDAS COLUNAS*
```
